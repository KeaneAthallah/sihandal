{{-- resources/views/sumberdana/create.blade.php --}}
<x-app-layout>
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
                <h2 class="text-xl font-bold text-gray-800">Tambah Sumber Dana</h2>
                <p class="text-sm text-gray-500 mt-1">Isi form berikut untuk menambahkan data sumber dana baru</p>
            </div>

            <form method="POST" action="{{ route('sumberdana.store') }}" class="p-6 space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="kd_skpd" name="kd_skpd" value="{{ old('kd_skpd') }}"
                    ...
                    <div>
                        <label for="nm_skpd" class="block text-sm font-medium text-gray-700 mb-1">NM SKPD <span
                                class="text-red-500">*</span></label>
                        <input type="text" id="nm_skpd" name="nm_skpd" value="{{ old('nm_skpd') }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition"
                            required>
                        @error('nm_skpd')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <input type="text" id="kd_subunit" name="kd_subunit" value="{{ old('kd_subunit') }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition">
                        @error('kd_subunit')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="nm_subunit" name="nm_subunit" value="{{ old('nm_subunit') }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition">
                        @error('nm_subunit')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        <label for="kd_kegiatan" class="block text-sm font-medium text-gray-700 mb-1">KD
                            KEGIATAN</label>
                        <input type="text" id="kd_kegiatan" name="kd_kegiatan" value="{{ old('kd_kegiatan') }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition">
                        @error('kd_kegiatan')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        <label for="nm_kegiatan" class="block text-sm font-medium text-gray-700 mb-1">NM
                            KEGIATAN</label>
                        <input type="text" id="nm_kegiatan" name="nm_kegiatan" value="{{ old('nm_kegiatan') }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition">
                        @error('nm_kegiatan')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="kd_rek" name="kd_rek" value="{{ old('kd_rek') }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition">
                        @error('kd_rek')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="nm_rek" name="nm_rek" value="{{ old('nm_rek') }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition">
                        @error('nm_rek')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        <label for="pagu" class="block text-sm font-medium text-gray-700 mb-1">PAGU <span
                                class="text-red-500">*</span></label>
                        <input type="number" id="pagu" name="pagu" value="{{ old('pagu') }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition"
                            required>
                        @error('pagu')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
