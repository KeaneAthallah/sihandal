    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
                <h2 class="text-xl font-bold text-gray-800">Edit Realisasi Rincian Belanja</h2>
                <p class="text-sm text-gray-500 mt-1">Edit data realisasi belanja yang sudah ada</p>
            </div>

            <form method="POST" action="{{ route('realisasi.update', $realisasi->id) }}" class="p-6 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select id="bulan" name="bulan"
                            ...
                            <option value="1" {{ old('bulan', $realisasi->bulan) == '1' ? 'selected' : '' }}>
                                Januari</option>
                            <option value="2" {{ old('bulan', $realisasi->bulan) == '2' ? 'selected' : '' }}>
                                Februari</option>
                            <option value="3" {{ old('bulan', $realisasi->bulan) == '3' ? 'selected' : '' }}>Maret
                            </option>
                            <option value="4" {{ old('bulan', $realisasi->bulan) == '4' ? 'selected' : '' }}>April
                            </option>
                            <option value="5" {{ old('bulan', $realisasi->bulan) == '5' ? 'selected' : '' }}>Mei
                            </option>
                            <option value="6" {{ old('bulan', $realisasi->bulan) == '6' ? 'selected' : '' }}>Juni
                            </option>
                            <option value="7" {{ old('bulan', $realisasi->bulan) == '7' ? 'selected' : '' }}>Juli
                            </option>
                            <option value="8" {{ old('bulan', $realisasi->bulan) == '8' ? 'selected' : '' }}>
                                Agustus</option>
                            <option value="9" {{ old('bulan', $realisasi->bulan) == '9' ? 'selected' : '' }}>
                                September</option>
                            <option value="10" {{ old('bulan', $realisasi->bulan) == '10' ? 'selected' : '' }}>
                                Oktober</option>
                            <option value="11" {{ old('bulan', $realisasi->bulan) == '11' ? 'selected' : '' }}>
                                November</option>
                            <option value="12" {{ old('bulan', $realisasi->bulan) == '12' ? 'selected' : '' }}>
                                Desember</option>
                        </select>
                        @error('bulan')
                    ...
                    <div>
                        ...
                        <input type="date" id="tgl_sp2d" name="tgl_sp2d"
                            value="{{ old('tgl_sp2d', $realisasi->tgl_sp2d) }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="no_sp2d" name="no_sp2d"
                            value="{{ old('no_sp2d', $realisasi->no_sp2d) }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition"
                            required>
                        @error('no_sp2d')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    ...
                    <div>
                        <label for="kdskpd" class="block text-sm font-medium text-gray-700 mb-1">KD SKPD <span
                                class="text-red-500">*</span></label>
                        <input type="text" id="kdskpd" name="kdskpd"
                            value="{{ old('kdskpd', $realisasi->kdskpd) }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition"
                            required>
                        @error('kdskpd')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    ...
                    <div>
                        <label for="nmskpd" class="block text-sm font-medium text-gray-700 mb-1">NM SKPD <span
                                class="text-red-500">*</span></label>
                        <input type="text" id="nmskpd" name="nmskpd"
                            value="{{ old('nmskpd', $realisasi->nmskpd) }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition"
                            required>
                        @error('nmskpd')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <input type="text" id="kdsubunit" name="kdsubunit"
                            value="{{ old('kdsubunit', $realisasi->kdsubunit) }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition">
                        @error('kdsubunit')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="nmsubunit" name="nmsubunit"
                            value="{{ old('nmsubunit', $realisasi->nmsubunit) }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition">
                        @error('nmsubunit')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="kdkegiatan" name="kdkegiatan"
                            value="{{ old('kdkegiatan', $realisasi->kdkegiatan) }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition">
                        @error('kdkegiatan')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        <label for="nmkegiatan" class="block text-sm font-medium text-gray-700 mb-1">NM
                            KEGIATAN</label>
                        <input type="text" id="nmkegiatan" name="nmkegiatan"
                            value="{{ old('nmkegiatan', $realisasi->nmkegiatan) }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition">
                        @error('nmkegiatan')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="kdsubkegiatan" name="kdsubkegiatan"
                            value="{{ old('kdsubkegiatan', $realisasi->kdsubkegiatan) }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition">
                        @error('kdsubkegiatan')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="nmsubkegiatan" name="nmsubkegiatan"
                            value="{{ old('nmsubkegiatan', $realisasi->nmsubkegiatan) }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition">
                        @error('nmsubkegiatan')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="kdrek" name="kdrek"
                            value="{{ old('kdrek', $realisasi->kdrek) }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition">
                        @error('kdrek')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="nmrek" name="nmrek"
                            value="{{ old('nmrek', $realisasi->nmrek) }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition">
                        @error('nmrek')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select id="sumberdana" name="sumberdana"
                            ...
                            <option value="APBD"
                                {{ old('sumberdana', $realisasi->sumberdana) == 'APBD' ? 'selected' : '' }}>APBD
                            </option>
                            <option value="APBN"
                                {{ old('sumberdana', $realisasi->sumberdana) == 'APBN' ? 'selected' : '' }}>APBN
                            </option>
                            <option value="DAK"
                                {{ old('sumberdana', $realisasi->sumberdana) == 'DAK' ? 'selected' : '' }}>DAK</option>
                            <option value="Dana Desa"
                                {{ old('sumberdana', $realisasi->sumberdana) == 'Dana Desa' ? 'selected' : '' }}>Dana
                                Desa</option>
                        </select>
                        @error('sumberdana')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <select id="id_smb" name="id_smb"
                            ...
                            @foreach ($sumberDana as $smb)
                                <option value="{{ $smb->id }}"
                                    {{ old('id_smb', $realisasi->id_smb) == $smb->id ? 'selected' : '' }}>
