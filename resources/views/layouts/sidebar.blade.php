        ...
        @if (auth()->user()->role == 'admin')
            <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
                ...
                <div class="pt-4 mt-4 border-t border-gray-200">
                    <!-- Pengaturan Pagu Menu (Added here) -->
                    <a href="{{ route('admin.setting') }}"
                        class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-700 transition group {{ request()->routeIs('admin.setting') ? 'bg-blue-50 text-blue-700' : '' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span class="text-sm font-medium">Pengaturan Pagu</span>
                    </a>
